...
class Expression
{
 ...
 protected:
  ...
  // Child class implements how to map the expression into an escape
  // analysis object.
  // Must be implemented.
 ...
 private:
  ...
  convert_type_to_interface(Translate_context*, Type*, Type*, tree,
			    source_location, bool in_stack = false);
...
class Bound_method_expression : public Expression
{
 ...
 protected:
   // FIXME. Figure out the appropriate action for escape analysis here.
  Escape_analysis_object*
  do_get_escape_analysis_object(Escape_analysis_info*)
  { return NULL; }
